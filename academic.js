...
function notifyMobileUser() {
    if (detectMobileDevice()) {
        alert("You are viewing this page on a mobile device. Drew is currently too lazy to create a mobile view. For the best experience, please consider using a desktop. - Drew :>");
    }
}
